...
@section('title', 'iPorsa - Comment Page')
          ...
          <tbody>
            @foreach($comments as $comment)
                <tr>
                    ...
                    <td>{{isset($comment->post->title) ? $comment->post->title : 'N/A'}}</td>
                    <td>{{$comment->comment}}</td>
                    <td>{{isset($comment->created_at) ? $comment->created_at->format('M d D, Y g: i a') : 'N/A'}}</td>
                    <td>
